...
class cupri_irankish_gateway extends cupri_abstract_gateway
{
    ...
    function end($payment_data)
    {
        ...
        if ($order_id != '') {
            ...
            $referenceId = isset($_POST['referenceId']) ? sanitize_text_field($_POST['referenceId']) : 0;
            $paymentId = isset($_POST["paymentId"]) ? sanitize_text_field($_POST['paymentId']) : 0;
            if ($resultCode == '100') {
                ...
                echo cupri_failed_msg('خظا:' . esc_html($res));
            }
    ...
    function tab_contents()
    {
        ...
        echo '<p class="fields"><label><strong>درگاه جدید ایران کیش</strong><br>
                <p>⚠️ اگر این درگاه برای شما کار نمی کند باید درگاه جدید را تهیه کنید</p>
                <a href="https://wp-master.ir/?p=13874">برای دریافت درگاه جدید ایران کیش کلیک کنید</a>
                </label></p>';
